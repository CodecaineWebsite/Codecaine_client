<template>
	<div
		class="min-h-screen bg-card-background flex items-center justify-center p-8"
	>
		<div
			class="group w-90 bg-card-text text-white rounded-lg shadow-md transition-all duration-300 ease-in-out transform scale-95 translate-y-1 hover:scale-100 hover:translate-y-0 hover:shadow-2xl relative"
		>
			<!-- 預覽圖片 -->
			<div class="relative">
				<img
