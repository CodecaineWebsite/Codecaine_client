<template>
  <section class="px-6 py-4 relative group">
    ...
    <div class="max-w-[1140px] mx-auto mb-6">
      <div class="bg-[#1E1F26] px-[18.75px] pt-[9.375px] pb-[7.5px] w-full rounded flex items-center">
        <span :class="[!isTop ? 'text-white' : 'text-gray-400', 'text-sm mr-2']">Recent</span>
        ...
        <span :class="[isTop ? 'text-white' : 'text-gray-400', 'text-sm ml-2']">Top</span>
      </div>
    </div>
